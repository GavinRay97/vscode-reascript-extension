...
function reaper.ImGui_AcceptDragDropPayload(ctx, type, payload, integer) end
...
function reaper.ImGui_AcceptDragDropPayloadFiles(ctx, count, integer) end
...
function reaper.ImGui_AcceptDragDropPayloadRGB(ctx, rgb, integer) end
...
function reaper.ImGui_AcceptDragDropPayloadRGBA(ctx, rgba, integer) end
...
---@param str_id string
---@param dir integer
function reaper.ImGui_ArrowButton(reaper, ctx, str_id, dir) end
...
---@param ctxImGui_Resource ImGui_Context
function reaper.ImGui_Attach(ctxImGui_Resource) end
...
---@param boolean optional
---@param integer optional
---@return boolean retval, optional boolean
function reaper.ImGui_Begin(ctx, name, boolean, integer) end
...
---@param boolean optional
---@param integer optional
function reaper.ImGui_BeginChild(reaper, ctx, str_id, number, number, boolean, integer) end
...
---@param size_h number
---@param integer optional
function reaper.ImGui_BeginChildFrame(reaper, ctx, str_id, size_w, size_h, integer) end
...
---@param integer optional
function reaper.ImGui_BeginCombo(reaper, ctx, label, preview_value, integer) end
...
---@param ctx ImGui_Context
---@param boolean optional
function reaper.ImGui_BeginDisabled(ctx, boolean) end
...
---@param ctx ImGui_Context
---@param integer optional
function reaper.ImGui_BeginDragDropSource(reaper, ctx, integer) end
...
---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_BeginDragDropTarget(reaper, ctx) end
...
---@param number optional
---@param number optional
function reaper.ImGui_BeginListBox(reaper, ctx, label, number, number) end
...
---@param label string
---@param boolean optional
function reaper.ImGui_BeginMenu(reaper, ctx, label, boolean) end

---Append to menu-bar of current window (requires WindowFlags_MenuBar flag set
---on parent window). See EndMenuBar.
---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_BeginMenuBar(reaper, ctx) end
...
---@param str_id string
---@param integer optional
function reaper.ImGui_BeginPopup(reaper, ctx, str_id, integer) end
...
---@param string optional
---@param integer optional
function reaper.ImGui_BeginPopupContextItem(reaper, ctx, string, integer) end
...
---@param string optional
---@param integer optional
function reaper.ImGui_BeginPopupContextWindow(reaper, ctx, string, integer) end
...
---@param integer optional
---@return boolean retval, optional boolean
function reaper.ImGui_BeginPopupModal(ctx, name, boolean, integer) end
...
---@param str_id string
---@param integer optional
function reaper.ImGui_BeginTabBar(reaper, ctx, str_id, integer) end
...
---@param integer optional
---@return boolean retval, optional boolean
function reaper.ImGui_BeginTabItem(ctx, label, boolean, integer) end
...
---@param number optional
---@param number optional
function reaper.ImGui_BeginTable(reaper, ctx, str_id, column, integer, number, number, number) end

---Begin/append a tooltip window.
---To create full-featured tooltip (with any kind of items).
---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_BeginTooltip(reaper, ctx) end
...
---@param number optional
---@param number optional
function reaper.ImGui_Button(reaper, ctx, label, number, number) end
...
function reaper.ImGui_CalcTextSize(ctx, text, w, h, boolean, number) end
...
function reaper.ImGui_CollapsingHeader(ctx, label, p_visible, integer) end
...
---@param number optional
---@param number optional
function reaper.ImGui_ColorButton(reaper, ctx, desc_id, col_rgba, integer, number, number) end
...
function reaper.ImGui_ColorEdit3(ctx, label, col_rgb, integer) end
...
function reaper.ImGui_ColorEdit4(ctx, label, col_rgba, integer) end
...
---@param integer optional
---@return boolean retval, integer col_rgb
function reaper.ImGui_ColorPicker3(ctx, label, col_rgb, integer) end
...
---@param integer optional
---@return boolean retval, integer col_rgba
function reaper.ImGui_ColorPicker4(ctx, label, col_rgba, integer, integer) end
...
function reaper.ImGui_Combo(ctx, label, current_item, items, integer) end
...
---@param reaper ImGui_Context
---@param label string
---@param integer optional
function reaper.ImGui_CreateContext(reaper, label, integer) end

---@param reaper ImGui_DrawListSplitter
---@param draw_list ImGui_DrawList
function reaper.ImGui_CreateDrawListSplitter(reaper, draw_list) end
...
---@param reaper ImGui_Font
---@param family_or_file string
---@param size integer
---@param integer optional
function reaper.ImGui_CreateFont(reaper, family_or_file, size, integer) end
...
---@param reaper ImGui_Function
---@param code string
function reaper.ImGui_CreateFunctionFromEEL(reaper, code) end
...
---@param reaper ImGui_Image
---@param file string
---@param integer optional
function reaper.ImGui_CreateImage(reaper, file, integer) end
...
---@param reaper ImGui_Image
---@param data string
function reaper.ImGui_CreateImageFromMem(reaper, data) end
...
---@param reaper ImGui_ListClipper
---@param ctx ImGui_Context
function reaper.ImGui_CreateListClipper(reaper, ctx) end

---Valid while used every frame unless attached to a context (see Attach).
---@param reaper ImGui_TextFilter
---@param string optional
function reaper.ImGui_CreateTextFilter(reaper, string) end
...
---ValidatePtr.
---@param ctxImGui_Resource ImGui_Context
function reaper.ImGui_Detach(ctxImGui_Resource) end
...
function reaper.ImGui_DragDouble(ctx, label, v, number, number, number, string, integer) end
...
function reaper.ImGui_DragDouble2(ctx, label, v1, v2, number, number, number, string, integer) end
...
function reaper.ImGui_DragDouble3(ctx, label, v1, v2, v3, number, number, number, string, integer) end
...
function reaper.ImGui_DragDouble4(ctx, label, v1, v2, v3, v4, number, number, number, string, integer) end

---@param reaper boolean
---@param ctx ImGui_Context
---@param labelreaper_array string
---@param number optional
---@param number optional
---@param number optional
---@param string optional
---@param integer optional
function reaper.ImGui_DragDoubleN(reaper, ctx, labelreaper_array, number, number, number, string, integer) end
...
function reaper.ImGui_DragFloatRange2(ctx, label, v_current_min, v_current_max, number, number, number, string, string, integer) end
...
function reaper.ImGui_DragInt(ctx, label, v, number, integer, integer, string, integer) end
...
function reaper.ImGui_DragInt2(ctx, label, v1, v2, number, integer, integer, string, integer) end
...
function reaper.ImGui_DragInt3(ctx, label, v1, v2, v3, number, integer, integer, string, integer) end
...
function reaper.ImGui_DragInt4(ctx, label, v1, v2, v3, v4, number, integer, integer, string, integer) end
...
function reaper.ImGui_DragIntRange2(ctx, label, v_current_min, v_current_max, number, integer, integer, string, string, integer) end
...
---@param integer optional
function reaper.ImGui_DrawList_AddBezierCubic(draw_list, p1_x, p1_y, p2_x, p2_y, p3_x, p3_y, p4_x, p4_y, col_rgba, thickness, integer) end
...
---@param thickness number
---@param integer optional
function reaper.ImGui_DrawList_AddBezierQuadratic(draw_list, p1_x, p1_y, p2_x, p2_y, p3_x, p3_y, col_rgba, thickness, integer) end
...
---@param integer optional
---@param number optional
function reaper.ImGui_DrawList_AddCircle(draw_list, center_x, center_y, radius, col_rgba, integer, number) end
...
---@param col_rgba integer
---@param integer optional
function reaper.ImGui_DrawList_AddCircleFilled(draw_list, center_x, center_y, radius, col_rgba, integer) end

---Note: Anti-aliased filling requires points to be in clockwise order.
---@param draw_listreaper_array ImGui_DrawList
---@param col_rgba integer
function reaper.ImGui_DrawList_AddConvexPolyFilled(draw_listreaper_array, col_rgba) end

---@param draw_listImGui_Image ImGui_DrawList
...
---@param number optional
---@param integer optional
function reaper.ImGui_DrawList_AddImage(draw_listImGui_Image, p_min_x, p_min_y, p_max_x, p_max_y, number, number, number, number, integer) end
...
---@param number optional
---@param integer optional
function reaper.ImGui_DrawList_AddImageQuad(draw_listImGui_Image, p1_x, p1_y, p2_x, p2_y, p3_x, p3_y, p4_x, p4_y, number, number, number, number, number, number, number, number, integer) end
...
---@param integer optional
function reaper.ImGui_DrawList_AddImageRounded(draw_listImGui_Image, p_min_x, p_min_y, p_max_x, p_max_y, uv_min_x, uv_min_y, uv_max_x, uv_max_y, col_rgba, rounding, integer) end
...
---@param col_rgba integer
---@param number optional
function reaper.ImGui_DrawList_AddLine(draw_list, p1_x, p1_y, p2_x, p2_y, col_rgba, number) end
...
---@param number optional
function reaper.ImGui_DrawList_AddNgon(draw_list, center_x, center_y, radius, col_rgba, num_segments, number) end
...
---@param flags integer
---@param thickness number
function reaper.ImGui_DrawList_AddPolyline(draw_listreaper_array, col_rgba, flags, thickness) end
...
---@param col_rgba integer
---@param number optional
function reaper.ImGui_DrawList_AddQuad(draw_list, p1_x, p1_y, p2_x, p2_y, p3_x, p3_y, p4_x, p4_y, col_rgba, number) end
...
---@param integer optional
---@param number optional
function reaper.ImGui_DrawList_AddRect(draw_list, p_min_x, p_min_y, p_max_x, p_max_y, col_rgba, number, integer, number) end
...
---@param number optional
---@param integer optional
function reaper.ImGui_DrawList_AddRectFilled(draw_list, p_min_x, p_min_y, p_max_x, p_max_y, col_rgba, number, integer) end
...
---@param draw_listImGui_Font ImGui_DrawList
...
---@param number optional
---@param number optional
function reaper.ImGui_DrawList_AddTextEx(draw_listImGui_Font, font_size, pos_x, pos_y, col_rgba, text, number, number, number, number, number) end
...
---@param col_rgba integer
---@param number optional
function reaper.ImGui_DrawList_AddTriangle(draw_list, p1_x, p1_y, p2_x, p2_y, p3_x, p3_y, col_rgba, number) end
...
---@param a_max number
---@param integer optional
function reaper.ImGui_DrawList_PathArcTo(draw_list, center_x, center_y, radius, a_min, a_max, integer) end
...
---@param p4_y number
---@param integer optional
function reaper.ImGui_DrawList_PathBezierCubicCurveTo(draw_list, p2_x, p2_y, p3_x, p3_y, p4_x, p4_y, integer) end
...
---@param p3_y number
---@param integer optional
function reaper.ImGui_DrawList_PathBezierQuadraticCurveTo(draw_list, p2_x, p2_y, p3_x, p3_y, integer) end
...
---@param number optional
---@param integer optional
function reaper.ImGui_DrawList_PathRect(draw_list, rect_min_x, rect_min_y, rect_max_x, rect_max_y, number, integer) end

---@param draw_list ImGui_DrawList
---@param col_rgba integer
---@param integer optional
---@param number optional
function reaper.ImGui_DrawList_PathStroke(draw_list, col_rgba, integer, number) end
...
---@param boolean optional
function reaper.ImGui_DrawList_PushClipRect(draw_list, clip_rect_min_x, clip_rect_min_y, clip_rect_max_x, clip_rect_max_y, boolean) end
...
---@param func ImGui_Function
---@param namereaper_array string
function reaper.ImGui_Function_GetValue_Array(func, namereaper_array) end
...
---@param func ImGui_Function
---@param namereaper_array string
function reaper.ImGui_Function_SetValue_Array(func, namereaper_array) end
...
---@param reaper ImGui_DrawList
---@param ctx ImGui_Context
function reaper.ImGui_GetBackgroundDrawList(reaper, ctx) end
...
---@param number optional
---@return integer retval
function reaper.ImGui_GetColor(ctx, idx, number) end
...
---@param reaper ImGui_Font
---@param ctx ImGui_Context
function reaper.ImGui_GetFont(reaper, ctx) end
...
---@param reaper ImGui_DrawList
---@param ctx ImGui_Context
function reaper.ImGui_GetForegroundDrawList(reaper, ctx) end
...
---@param reaper ImGui_Viewport
---@param ctx ImGui_Context
function reaper.ImGui_GetMainViewport(reaper, ctx) end
...
---@param number optional
---@return number x, number y
function reaper.ImGui_GetMouseDragDelta(ctx, x, y, integer, number) end
...
---@param reaper ImGui_DrawList
---@param ctx ImGui_Context
function reaper.ImGui_GetWindowDrawList(reaper, ctx) end
...
---@param reaper ImGui_Viewport
---@param ctx ImGui_Context
function reaper.ImGui_GetWindowViewport(reaper, ctx) end
...
---@param ctxImGui_Image ImGui_Context
---@param size_w number
---@param size_h number
---@param number optional
---@param number optional
...
---@param integer optional
---@param integer optional
function reaper.ImGui_Image(ctxImGui_Image, size_w, size_h, number, number, number, number, integer, integer) end

---@param reaper boolean
---@param ctx ImGui_Context
---@param str_idImGui_Image string
---@param size_w number
---@param size_h number
---@param number optional
---@param number optional
...
---@param integer optional
---@param integer optional
function reaper.ImGui_ImageButton(reaper, ctx, str_idImGui_Image, size_w, size_h, number, number, number, number, integer, integer) end

---'img' cannot be another ImageSet.
---@param set ImGui_ImageSet
---@param scaleImGui_Image number
function reaper.ImGui_ImageSet_Add(set, scaleImGui_Image) end
...
---@param ctx ImGui_Context
---@param number optional
function reaper.ImGui_Indent(ctx, number) end
...
---@param integer optional
---@return boolean retval, number v
function reaper.ImGui_InputDouble(ctx, label, v, number, number, string, integer) end
...
---@param integer optional
---@return boolean retval, number v1, number v2
function reaper.ImGui_InputDouble2(ctx, label, v1, v2, string, integer) end
...
---@param integer optional
---@return boolean retval, number v1, number v2, number v3
function reaper.ImGui_InputDouble3(ctx, label, v1, v2, v3, string, integer) end
...
---@param integer optional
---@return boolean retval, number v1, number v2, number v3, number v4
function reaper.ImGui_InputDouble4(ctx, label, v1, v2, v3, v4, string, integer) end
...
---@param string optional
---@param integer optional
function reaper.ImGui_InputDoubleN(reaper, ctx, labelreaper_array, number, number, string, integer) end
...
---@param integer optional
---@return boolean retval, integer v
function reaper.ImGui_InputInt(ctx, label, v, integer, integer, integer) end
...
---@param integer optional
---@return boolean retval, integer v1, integer v2
function reaper.ImGui_InputInt2(ctx, label, v1, v2, integer) end
...
---@param integer optional
---@return boolean retval, integer v1, integer v2, integer v3
function reaper.ImGui_InputInt3(ctx, label, v1, v2, v3, integer) end
...
---@param integer optional
---@return boolean retval, integer v1, integer v2, integer v3, integer v4
function reaper.ImGui_InputInt4(ctx, label, v1, v2, v3, v4, integer) end

---@param ctx ImGui_Context
---@param label string
---@param buf string
---@param integer optional
---@param callbackIn flagsInImGui_Function
---@return boolean retval, string buf
function reaper.ImGui_InputText(ctx, label, buf, integer, callbackIn) end
...
---@param callbackIn flagsInImGui_Function
---@return boolean retval, string buf
function reaper.ImGui_InputTextMultiline(ctx, label, buf, number, number, integer, callbackIn) end
...
---@param callbackIn flagsInImGui_Function
---@return boolean retval, string buf
function reaper.ImGui_InputTextWithHint(ctx, label, hint, buf, integer, callbackIn) end
...
---@param size_h number
---@param integer optional
function reaper.ImGui_InvisibleButton(reaper, ctx, str_id, size_w, size_h, integer) end

---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_IsAnyItemActive(reaper, ctx) end

---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_IsAnyItemFocused(reaper, ctx) end

---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_IsAnyItemHovered(reaper, ctx) end

---Is any mouse button held?
---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_IsAnyMouseDown(reaper, ctx) end

---Was the last item just made active (item was previously inactive).
---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_IsItemActivated(reaper, ctx) end
...
---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_IsItemActive(reaper, ctx) end
...
---@param ctx ImGui_Context
---@param integer optional
function reaper.ImGui_IsItemClicked(reaper, ctx, integer) end

---Was the last item just made inactive (item was previously active).
---Useful for Undo/Redo patterns with widgets that require continuous editing.
---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_IsItemDeactivated(reaper, ctx) end
...
---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_IsItemDeactivatedAfterEdit(reaper, ctx) end
...
---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_IsItemEdited(reaper, ctx) end

---Is the last item focused for keyboard/gamepad navigation?
---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_IsItemFocused(reaper, ctx) end
...
---@param ctx ImGui_Context
---@param integer optional
function reaper.ImGui_IsItemHovered(reaper, ctx, integer) end

---Was the last item open state toggled? Set by TreeNode.
---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_IsItemToggledOpen(reaper, ctx) end

---Is the last item visible? (items may be out of sight because of clipping/scrolling)
---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_IsItemVisible(reaper, ctx) end

---Is key being held.
---@param reaper boolean
---@param ctx ImGui_Context
---@param key integer
function reaper.ImGui_IsKeyDown(reaper, ctx, key) end
...
---@param key integer
---@param boolean optional
function reaper.ImGui_IsKeyPressed(reaper, ctx, key, boolean) end

---Was key released (went from Down to !Down)?
---@param reaper boolean
---@param ctx ImGui_Context
---@param key integer
function reaper.ImGui_IsKeyReleased(reaper, ctx, key) end
...
---@param button integer
---@param boolean optional
function reaper.ImGui_IsMouseClicked(reaper, ctx, button, boolean) end
...
---@param ctx ImGui_Context
---@param button integer
function reaper.ImGui_IsMouseDoubleClicked(reaper, ctx, button) end

---Is mouse button held?
---@param reaper boolean
---@param ctx ImGui_Context
---@param button integer
function reaper.ImGui_IsMouseDown(reaper, ctx, button) end
...
---@param button integer
---@param number optional
function reaper.ImGui_IsMouseDragging(reaper, ctx, button, number) end
...
---@param boolean optional
function reaper.ImGui_IsMouseHoveringRect(reaper, ctx, r_min_x, r_min_y, r_max_x, r_max_y, boolean) end

---@param reaper boolean
---@param ctx ImGui_Context
---@param number optional
---@param number optional
function reaper.ImGui_IsMousePosValid(reaper, ctx, number, number) end

---Did mouse button released? (went from Down to !Down)
---@param reaper boolean
---@param ctx ImGui_Context
---@param button integer
function reaper.ImGui_IsMouseReleased(reaper, ctx, button) end
...
---@param str_id string
---@param integer optional
function reaper.ImGui_IsPopupOpen(reaper, ctx, str_id, integer) end
...
---@param size_w number
---@param size_h number
function reaper.ImGui_IsRectVisible(reaper, ctx, size_w, size_h) end
...
---@param rect_max_x number
---@param rect_max_y number
function reaper.ImGui_IsRectVisibleEx(reaper, ctx, rect_min_x, rect_min_y, rect_max_x, rect_max_y) end

---Use after Begin/BeginPopup/BeginPopupModal to tell if a window just opened.
---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_IsWindowAppearing(reaper, ctx) end

---Is current window docked into another window or a REAPER docker?
---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_IsWindowDocked(reaper, ctx) end
...
---@param ctx ImGui_Context
---@param integer optional
function reaper.ImGui_IsWindowFocused(reaper, ctx, integer) end
...
---@param ctx ImGui_Context
---@param integer optional
function reaper.ImGui_IsWindowHovered(reaper, ctx, integer) end
...
---@param integer optional
---@return boolean retval, integer current_item
function reaper.ImGui_ListBox(ctx, label, current_item, items, integer) end
...
---@param number optional
function reaper.ImGui_ListClipper_Begin(clipper, items_count, number) end
...
---@param reaper boolean
---@param clipper ImGui_ListClipper
function reaper.ImGui_ListClipper_Step(reaper, clipper) end
...
---@param ctx ImGui_Context
---@param integer optional
function reaper.ImGui_LogToClipboard(ctx, integer) end
...
---@param integer optional
---@param string optional
function reaper.ImGui_LogToFile(ctx, integer, string) end

---Start logging all text output from the interface to the TTY (stdout).
---@param ctx ImGui_Context
---@param integer optional
function reaper.ImGui_LogToTTY(ctx, integer) end
...
---@param boolean optional
---@return boolean retval, optional boolean
function reaper.ImGui_MenuItem(ctx, label, string, boolean, boolean) end
...
---@param str_id string
---@param integer optional
function reaper.ImGui_OpenPopup(ctx, str_id, integer) end
...
---@param string optional
---@param integer optional
function reaper.ImGui_OpenPopupOnItemClick(ctx, string, integer) end
...
---@param number optional
---@param number optional
function reaper.ImGui_PlotHistogram(ctx, labelreaper_array, integer, string, number, number, number, number) end
...
---@param number optional
---@param number optional
function reaper.ImGui_PlotLines(ctx, labelreaper_array, integer, string, number, number, number, number) end
...
---@param boolean optional
---@return number x, number y
function reaper.ImGui_PointConvertNative(ctx, x, y, boolean) end
...
---@param ctx ImGui_Context
---@param integer optional
function reaper.ImGui_PopStyleColor(ctx, integer) end

---Reset a style variable.
---@param ctx ImGui_Context
---@param integer optional
function reaper.ImGui_PopStyleVar(ctx, integer) end
...
---@param number optional
---@param string optional
function reaper.ImGui_ProgressBar(ctx, fraction, number, number, string) end
...
---@param ctxImGui_Font ImGui_Context
function reaper.ImGui_PushFont(ctxImGui_Font) end
...
---@param val1 number
---@param number optional
function reaper.ImGui_PushStyleVar(ctx, var_idx, val1, number) end
...
---@param ctx ImGui_Context
---@param number optional
function reaper.ImGui_PushTextWrapPos(ctx, number) end
...
---@param label string
---@param active boolean
function reaper.ImGui_RadioButton(reaper, ctx, label, active) end
...
---@param ctx ImGui_Context
---@param integer optional
function reaper.ImGui_ResetMouseDragDelta(ctx, integer) end
...
---@param number optional
---@param number optional
function reaper.ImGui_SameLine(ctx, number, number) end
...
function reaper.ImGui_Selectable(ctx, label, p_selected, integer, number, number) end
...
---@param data string
---@param integer optional
function reaper.ImGui_SetDragDropPayload(reaper, ctx, type, data, integer) end
...
---@param ctx ImGui_Context
---@param integer optional
function reaper.ImGui_SetKeyboardFocusHere(ctx, integer) end
...
---@param integer optional
function reaper.ImGui_SetNextItemOpen(ctx, is_open, integer) end
...
---@param integer optional
function reaper.ImGui_SetNextWindowCollapsed(ctx, collapsed, integer) end
...
---@param integer optional
function reaper.ImGui_SetNextWindowDockID(ctx, dock_id, integer) end
...
---@param number optional
---@param number optional
function reaper.ImGui_SetNextWindowPos(ctx, pos_x, pos_y, integer, number, number) end
...
---@param size_h number
---@param integer optional
function reaper.ImGui_SetNextWindowSize(ctx, size_w, size_h, integer) end
...
---@param size_max_hImGui_Function number
function reaper.ImGui_SetNextWindowSizeConstraints(ctx, size_min_w, size_min_h, size_max_w, size_max_hImGui_Function) end
...
---@param local_x number
---@param number optional
function reaper.ImGui_SetScrollFromPosX(ctx, local_x, number) end
...
---@param local_y number
---@param number optional
function reaper.ImGui_SetScrollFromPosY(ctx, local_y, number) end
...
---@param ctx ImGui_Context
---@param number optional
function reaper.ImGui_SetScrollHereX(ctx, number) end
...
---@param ctx ImGui_Context
---@param number optional
function reaper.ImGui_SetScrollHereY(ctx, number) end
...
---@param collapsed boolean
---@param integer optional
function reaper.ImGui_SetWindowCollapsed(ctx, collapsed, integer) end
...
---@param collapsed boolean
---@param integer optional
function reaper.ImGui_SetWindowCollapsedEx(ctx, name, collapsed, integer) end
...
---@param pos_y number
---@param integer optional
function reaper.ImGui_SetWindowPos(ctx, pos_x, pos_y, integer) end
...
---@param pos_y number
---@param integer optional
function reaper.ImGui_SetWindowPosEx(ctx, name, pos_x, pos_y, integer) end
...
---@param size_h number
---@param integer optional
function reaper.ImGui_SetWindowSize(ctx, size_w, size_h, integer) end
...
---@param size_h number
---@param integer optional
function reaper.ImGui_SetWindowSizeEx(ctx, name, size_w, size_h, integer) end
...
function reaper.ImGui_ShowAboutWindow(ctx, boolean) end

---Create Debug Log window. display a simplified log of important dear imgui events.
---@param ctx ImGui_Context
---@param boolean optional
---@return optional boolean
function reaper.ImGui_ShowDebugLogWindow(ctx, boolean) end
...
---@param boolean optional
---@return optional boolean
function reaper.ImGui_ShowMetricsWindow(ctx, boolean) end
...
---@param boolean optional
---@return optional boolean
function reaper.ImGui_ShowStackToolWindow(ctx, boolean) end
...
function reaper.ImGui_SliderAngle(ctx, label, v_rad, number, number, string, integer) end
...
---@param integer optional
---@return boolean retval, number v
function reaper.ImGui_SliderDouble(ctx, label, v, v_min, v_max, string, integer) end
...
---@param integer optional
---@return boolean retval, number v1, number v2
function reaper.ImGui_SliderDouble2(ctx, label, v1, v2, v_min, v_max, string, integer) end
...
---@param integer optional
---@return boolean retval, number v1, number v2, number v3
function reaper.ImGui_SliderDouble3(ctx, label, v1, v2, v3, v_min, v_max, string, integer) end
...
---@param integer optional
---@return boolean retval, number v1, number v2, number v3, number v4
function reaper.ImGui_SliderDouble4(ctx, label, v1, v2, v3, v4, v_min, v_max, string, integer) end
...
---@param string optional
---@param integer optional
function reaper.ImGui_SliderDoubleN(reaper, ctx, labelreaper_array, v_min, v_max, string, integer) end
...
---@param integer optional
---@return boolean retval, integer v
function reaper.ImGui_SliderInt(ctx, label, v, v_min, v_max, string, integer) end
...
---@param integer optional
---@return boolean retval, integer v1, integer v2
function reaper.ImGui_SliderInt2(ctx, label, v1, v2, v_min, v_max, string, integer) end
...
---@param integer optional
---@return boolean retval, integer v1, integer v2, integer v3
function reaper.ImGui_SliderInt3(ctx, label, v1, v2, v3, v_min, v_max, string, integer) end
...
---@param integer optional
---@return boolean retval, integer v1, integer v2, integer v3, integer v4
function reaper.ImGui_SliderInt4(ctx, label, v1, v2, v3, v4, v_min, v_max, string, integer) end

---Button with StyleVar_FramePadding=(0,0) to easily embed within text.
---@param reaper boolean
---@param ctx ImGui_Context
---@param label string
function reaper.ImGui_SmallButton(reaper, ctx, label) end
...
---@param label string
---@param integer optional
function reaper.ImGui_TabItemButton(reaper, ctx, label, integer) end
...
---@param integer optional
---@return integer retval
function reaper.ImGui_TableGetColumnFlags(ctx, integer) end
...
---@param integer optional
---@return string retval
function reaper.ImGui_TableGetColumnName(ctx, integer) end
...
---@param reaper boolean
---@param ctx ImGui_Context
function reaper.ImGui_TableNextColumn(reaper, ctx) end

---Append into the first cell of a new row.
---@param ctx ImGui_Context
---@param integer optional
---@param number optional
function reaper.ImGui_TableNextRow(ctx, integer, number) end
...
---@param integer optional
function reaper.ImGui_TableSetBgColor(ctx, target, color_rgba, integer) end
...
---@param ctx ImGui_Context
---@param column_n integer
function reaper.ImGui_TableSetColumnIndex(reaper, ctx, column_n) end
...
---@param number optional
---@param integer optional
function reaper.ImGui_TableSetupColumn(ctx, label, integer, number, integer) end
...
---@param reaper boolean
---@param filterImGui_Context ImGui_TextFilter
---@param string optional
---@param number optional
function reaper.ImGui_TextFilter_Draw(reaper, filterImGui_Context, string, number) end
...
---@param reaper boolean
---@param filter ImGui_TextFilter
function reaper.ImGui_TextFilter_IsActive(reaper, filter) end

---@param reaper boolean
---@param filter ImGui_TextFilter
---@param text string
function reaper.ImGui_TextFilter_PassFilter(reaper, filter, text) end
...
---@param label string
---@param integer optional
function reaper.ImGui_TreeNode(reaper, ctx, label, integer) end
...
---@param label string
---@param integer optional
function reaper.ImGui_TreeNodeEx(reaper, ctx, str_id, label, integer) end
...
---@param ctx ImGui_Context
---@param number optional
function reaper.ImGui_Unindent(ctx, number) end
...
---@param integer optional
---@return boolean retval, number v
function reaper.ImGui_VSliderDouble(ctx, label, size_w, size_h, v, v_min, v_max, string, integer) end
...
---@param integer optional
---@return boolean retval, integer v
function reaper.ImGui_VSliderInt(ctx, label, size_w, size_h, v, v_min, v_max, string, integer) end
...
---@param pointer identifier
---@param type string
function reaper.ImGui_ValidatePtr(reaper, pointer, type) end
